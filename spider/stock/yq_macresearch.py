...
def start_page(pageNo='1'):
    # 宏观研究
    # url = 'https://reportapi.eastmoney.com/report/jg?cb=datatable8655670&pageSize=50&beginTime=2021-01-06&endTime=2023-01-06&pageNo=2&fields=&qType=3&orgCode=&author=&p=2&pageNum=2&pageNumber=2&_=1672979891118'
...
def query_pdf_page(encodeUrl):
    url = f'https://data.eastmoney.com/report/zw_macresearch.jshtml?encodeUrl={encodeUrl}'
...
Table(['日期', '机构名称', '报告名称'], get_data(1)).to_html('./宏观研究', '宏观研究')
