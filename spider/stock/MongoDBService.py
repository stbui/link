...
class MongoDBService():
    ...
    def on_replace_one(self, raw_data):
        """数据库插入数据操作"""
        try:
            db = self.db_client[self.db_name]
            cl = db[self.db_cl]
